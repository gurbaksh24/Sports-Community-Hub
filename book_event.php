...
<body>
    ...
    <header>
        ...
        <div id="booking-form" class='register-page'>
            <div class="form-box1">
               <span onclick="document.getElementById('register-form').style.display='none'" class="close c1">&times;</span>
                <div class="form1">
                    <form class='register-form', action="book.php", method="post">
                        <h1 class="main-heading">Book Now</h1>
				        <select id="events-select" name="events">
                            <option class="football" value="football">Football</option>
                        ...
                        {
                            ?>
                            <span><p>Please login first</p></span>
                            <?php
                        }
                        
                        if($_GET['booking_success'])
                        {
                            ?>
                            <span><p>Booked your slot successfully</p></span>
                            <?php
                        }
                        ?>
                    </form>
